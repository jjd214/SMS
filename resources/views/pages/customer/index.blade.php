    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <!-- Search Form -->
                <form class="flex items-center max-w-sm mb-3" action="{{ route('customer.index') }}" method="get">
                    <div class="relative w-full">
                        ...
                        <input type="text" id="simple-search"
                            ...
                            placeholder="Search customer" name="search" required />
                    </div>
                    <button type="submit"
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4 flex gap-1">
                                        ...
                                        <form action="{{ route('customer.destroy', $customer->id) }}" method="post"
                                            onsubmit="confirm('Are you sure you want to delete {{ $customer->name }}')">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
                                                class="font-medium text-red-600
                                                dark:text-red-500 hover:underline">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-6">{{ __('No customer.') }}</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
